                  ...
                  <thead>
                    ...
                    <tbody>
					  ...
					  <tr>
							...
							<td><?php echo $table_data['type_name'];	?></td>
							<td><?php echo $table_data['type_name'];	?></td>
							<td><?php echo $table_data['mobile'];?></td>
							<td><?php echo $table_data['landline'];?></td>
							<td><?php echo $table_data['address'];?></td>
							<td><?php echo $table_data['city'];?></td>
							<td><?php echo $table_data['state'];?></td>
							<td><?php echo $table_data['country'];?></td>
							<td><?php echo $table_data['rooms'];?></td>
							<td><?php echo $table_data['facilities'];?></td>
							<td><?php echo $table_data['image'];?></td>
